...
class trainModel:
    ...
    def trainingModel(self):
        ...
        try:
            ...
            X.to_csv('Training_Raw_files_validated/finaltrainingdata.csv', index=False)
            ...
            for i in list_of_clusters:
                ...
                x_train, x_test, y_train, y_test = train_test_split(cluster_features, cluster_label, test_size=0.2, random_state=355, stratify=cluster_label)
...
if __name__ == "__main__":
    ...
    dataload = data_loader.Data_Getter(file_object, log_writer)
